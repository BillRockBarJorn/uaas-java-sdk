...
// InvalidBucketPolicyError generated when the given bucket policy is invalid.
export class InvalidBucketACLError extends ExtendableError {
  constructor(message) {
    super(message)
  }
}
...
// InvalidBucketPolicyError generated when the given bucket policy is invalid.
export class InvalidBucketQuotaError extends ExtendableError {
  constructor(message) {
    super(message)
  }
}
...
// S3Error is generated for errors returned from S3 server.
// see getErrorTransformer for details
export class StorageClassError extends ExtendableError {
  constructor(message) {
    super(message)
  }
}
...
// S3Error is generated for errors returned from S3 server.
// see getErrorTransformer for details
export class DirectiveError extends ExtendableError {
  constructor(message) {
    super(message)
  }
}
...
// S3Error is generated for errors returned from S3 server.
// see getErrorTransformer for details
export class AlgorithmError extends ExtendableError {
  constructor(message) {
    super(message)
  }
}