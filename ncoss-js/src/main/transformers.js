...
export function aclTransformer() {
  return getConcater(xmlParsers.parseACLConfig)
}

export function quotaTransformer() {
  return getConcater(xmlParsers.parseQuotaConfig)
}
