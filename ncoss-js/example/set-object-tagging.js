...
s3ClientV4.setObjectTagging('ncoss-4js', '2023/04/23/a.avi', tagsMap, function (err){
  if (err) {
...
// client.setObjectTagging('bucketname', "object-name", tagsMap, { versionId: "my-version-id" }, function (err){
//   if (err) {
//     return console.log(err)
//   }
//   console.log("Success")
