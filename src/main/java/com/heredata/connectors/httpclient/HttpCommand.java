...
import com.heredata.uaas.core.transport.ObjectMapperSingleton;
import com.heredata.uaas.core.transport.functions.EndpointURIFromRequestFunction;
        ...
        if (request.getEntity() != null) {
            if (InputStream.class.isAssignableFrom(request.getEntity().getClass())) {
                ...
                builder = EntityBuilder.create()
                        ...
                        .setText(ObjectMapperSingleton.getContext(request.getEntity().getClass())
                                        .writer().writeValueAsString(request.getEntity())
                        );
            }
