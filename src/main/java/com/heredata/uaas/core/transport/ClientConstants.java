...
public final class ClientConstants {
    ...
    public static final String HEADER_X_ACCESS_KEY = "X-Access-Key";
    public static final String HEADER_X_SUBJECT_TOKEN = "X-Subject-Token";
    public static final String AUTH_S3_REQUIRED = "Auth-S3-Required";
    ...
    // conent域JSON的key
    public static final String CONTENT_JSON_ROOT_NAME = "jsonRootName";
    public static final String CONTENT_HEAD_JSON_ROOT_NAME = "head";
    ...
    public static final String PATH_S3KEY = "/auth/secretkey";
    public static final String PATH_PUBLUC_KEY = "/auth/publickey";
    public static final String PATH_TENANTS = "/tenants";
    public static final String PATH_ARTIFACTS = "/artifacts";
    public static final String PATH_ACCESSKEY = "/accessKeys";
