...
import com.heredata.uaas.openstack.common.BasicResourceEntity;
import com.heredata.uaas.openstack.common.IdResourceEntity;
...
public class KeystoneAuth implements Authentication, AuthStore {
    ...
    public KeystoneAuth(AuthIdentity identity, AuthScope scope) {
    ...
    public static final class AuthIdentity implements Identity, Serializable {
        ...
        public static AuthIdentity createCredentialType(String username, String password) {
            Identifier domain = new Identifier(Identifier.Type.NAME, "default");
            return createCredentialType(username, password, domain);
        }
