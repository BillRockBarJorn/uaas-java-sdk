...
//            prefixQuery.setStartAfter("2023/04/26");
            ObjectListing example1 = hos.listObjects("ncoss-4");
...
//            example2.getVersionSummaries().stream().forEach(item -> System.out.println(item.getKey()));
    ...
    public void listObjectsByPage() {
        ...
        try {
            ...
            do {
                System.out.println("============第 " + index + " 页=================");
                // 构建请求参数并查询
                objectListing = hos.listObjects(new ListObjectsRequest("ncoss-4")
                        .withStartAfter(nextStartAfter).withMaxKeys(2));
    ...
    public void getObject() throws IOException {
        ...
        try {
            ...
            getObjectRequest.setVersionId("2dafff6c487411eeb3a4fa163e2fcf06");
...
//            hos.downloadObject(downloadFileRequest);
    ...
    public void deleteObject() {
        ...
        try {
            ...
            deleteObjectsRequest.setVersionId("2dafff6c487411eeb3a4fa163e2fcf06");
    ...
    public void setObjectAcl() {
        ...
        // 如果对象有版本号，必须要填写版本号
        setAclRequest.setVersionId("62c707ea487411eeb3a4fa163e2fcf06");
        try {
            // 设置
    ...
    public void getObjectAcl() {
        S3 hos = getS3Client();
        try {
            GenericRequest genericRequest = new GenericRequest("ncoss-4", "a/b/c/d", "62c707ea487411eeb3a4fa163e2fcf06");
...
//                System.out.println(ServiceException.getMessage());
    ...
    public void initiateMultipartUpload() {
        ...
        InitiateMultipartUploadRequest initiateMultipartUploadRequest =
                new InitiateMultipartUploadRequest("ncoss-8", "2022/08/3123/4.avi");
        try {
