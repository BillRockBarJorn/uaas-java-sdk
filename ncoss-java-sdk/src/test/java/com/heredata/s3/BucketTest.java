...
public class BucketTest extends TestBase {
    ...
    public void createBucket() {
        ...
        try {
            ...
            CreateBucketRequest createBucketRequest = new CreateBucketRequest("ncoss-8");
    ...
    public void getBucketDetail() {
        S3 hos = getS3Client();
        try {
            if (hos.doesBucketExist("ncoss-8")) {

                //查询桶名为"example"的详情
                Bucket bucket = hos.getBucketInfo("ncoss-8");
    ...
    public void deleteBucket() {
        S3 hos = getS3Client();
        try {
            VoidResult result = hos.deleteBucket("ncoss-8");
            if (result.getResponse().isSuccessful()) {
    ...
    public void setBucketQuota() {
        ...
        setBucketQuota.setBucketName("ncoss-8");
        try {
    ...
    public void getBucketQuota() {
        S3 hos = getS3Client();
        try {
            BucketQuotaResult result = hos.getBucketQuota("ncoss-8");
    ...
    public void setBucketPolicy() {
        ...
        String policyText = "{\"Version\":\"2023-04-04\",\"Statement\":[{\"Sid\":\"Stmt1375240018061\",\"Action\":[\"PutBucketAcl\"]" +
                ",\"Effect\":\"Allow\",\"Resource\":[\"example\"],\"Principal\":{\"AWS\":[\"test_pro1:root\"]}}]}";
        try {
            VoidResult result = hos.setBucketPolicy("ncoss-8", policyText);
            if (result.getResponse().isSuccessful()) {
    ...
    public void getBucketPolicy() {
        S3 hos = getS3Client();
        try {
            GetBucketPolicyResult bucket1 = hos.getBucketPolicy("ncoss-8");
    ...
    public void deleteBucketPolicy() {
        S3 hos = getS3Client();
        try {
            VoidResult bucket1 = hos.deleteBucketPolicy("ncoss-8");
            System.out.println(bucket1);
        } catch (ServiceException oe) {
            System.out.println("Error Message:" + oe.getErrorMessage());
            System.out.println("Error Code:" + oe.getErrorCode());
    ...
    public void setBucketACL() {
        ...
        try {
            // 设置
            VoidResult result = hos.setBucketAcl("ncoss-8", setBucketAclRequest);
            if (result.getResponse().isSuccessful()) {
    ...
    public void getBucketACL() {
        S3 hos = getS3Client();
        try {
            AccessControlList result = hos.getBucketAcl("ncoss-8");
            System.out.println(result);
        } catch (ServiceException oe) {
            System.out.println("Error Message:" + oe.getErrorMessage());
            System.out.println("Error Code:" + oe.getErrorCode());
    ...
    public void setBucketVersioning() {
        ...
        // 创建请求对象
        SetBucketVersioningRequest setBucketVersioningRequest = new SetBucketVersioningRequest("ncoss-8", bucketVersioningConfiguration);
        try {
            // 设置桶生命周期
    ...
    public void getBucketVersioning() {
        S3 hos = getS3Client();
        try {
            BucketVersioningConfiguration result = hos.getBucketVersioning("ncoss-8");
            System.out.println(result);
        } catch (ServiceException oe) {
            System.out.println("Error Message:" + oe.getErrorMessage());
            System.out.println("Error Code:" + oe.getErrorCode());
    ...
    public void setBucketLifecycle() {
        ...
        SetBucketLifecycleRequest setBucketLifecycleRequest = new SetBucketLifecycleRequest("ncoss-8");
    ...
    public void getBucketLifecycle() {
        S3 hos = getS3Client();
        try {
            List<LifecycleRule> result = hos.getBucketLifecycle("ncoss-9");
            System.out.println(result);
        } catch (ServiceException oe) {
            System.out.println("Error Message:" + oe.getErrorMessage());
            System.out.println("Error Code:" + oe.getErrorCode());
