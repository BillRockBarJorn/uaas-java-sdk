...
import static com.heredata.s3.comm.S3Headers.COPY_OBJECT_METADATA_DIRECTIVE;
import static com.heredata.s3.comm.S3Headers.HOS_STORAGE_CLASS;
...
public class ObjectMetadata {
    ...
    public Date getLastModified() {
        return (Date) metadata.get(S3Headers.LAST_MODIFIED);
    }
    ...
    public void setLastModified(Date lastModified) {
        metadata.put(S3Headers.LAST_MODIFIED, lastModified);
    }
    ...
    public void setExpirationTime(Date expirationTime) {
        metadata.put(S3Headers.EXPIRES, DateUtil.formatRfc822Date(expirationTime));
    }
    ...
    public long getContentLength() {
        Long contentLength = (Long) metadata.get(S3Headers.CONTENT_LENGTH);
    ...
    public void setContentLength(long contentLength) {
        metadata.put(S3Headers.CONTENT_LENGTH, contentLength);
    }
    ...
    public String getContentType() {
        return (String) metadata.get(S3Headers.CONTENT_TYPE);
    }
    ...
    public void setContentType(String contentType) {
        metadata.put(S3Headers.CONTENT_TYPE, contentType);
    }
    ...
    public String getContentMD5() {
        return (String) metadata.get(S3Headers.CONTENT_MD5);
    }
    ...
    public void setContentMD5(String contentMD5) {
        metadata.put(S3Headers.CONTENT_MD5, contentMD5);
    }
    ...
    public String getContentEncoding() {
        return (String) metadata.get(S3Headers.CONTENT_ENCODING);
    }
    ...
    public void setContentEncoding(String encoding) {
        metadata.put(S3Headers.CONTENT_ENCODING, encoding);
    }
    ...
    public String getCacheControl() {
        return (String) metadata.get(S3Headers.CACHE_CONTROL);
    }
    ...
    public void setCacheControl(String cacheControl) {
        metadata.put(S3Headers.CACHE_CONTROL, cacheControl);
    }
    ...
    public String getContentDisposition() {
        return (String) metadata.get(S3Headers.CONTENT_DISPOSITION);
    }
    ...
    public void setContentDisposition(String disposition) {
        metadata.put(S3Headers.CONTENT_DISPOSITION, disposition);
    }
    ...
    public String getETag() {
        return (String) metadata.get(S3Headers.ETAG);
    }
    ...
    public String getServerSideEncryption() {
        return (String) metadata.get(S3Headers.HOS_SERVER_SIDE_ENCRYPTION);
    }
    ...
    public void setServerSideEncryption(String serverSideEncryption) {
        metadata.put(S3Headers.HOS_SERVER_SIDE_ENCRYPTION, serverSideEncryption);
    }
    ...
    public String getServerSideEncryptionKeyId() {
        return (String) metadata.get(S3Headers.HOS_SERVER_SIDE_ENCRYPTION_KEY_ID);
    }
    ...
    public void setServerSideEncryptionKeyId(String serverSideEncryptionKeyId) {
        metadata.put(S3Headers.HOS_SERVER_SIDE_ENCRYPTION_KEY_ID, serverSideEncryptionKeyId);
    }
    ...
    public void setClientSideEncryptionAlgorithm(AlgorithmEnum algorithmEnum) {
        metadata.put(S3Headers.HOS_CLIENT_SIDE_ENCRYPTION_ALGORITHM, algorithmEnum.getAlgorithm());
    }
    ...
    public String getClientSideEncryptionAlgorithm() {
        return metadata.get(S3Headers.HOS_CLIENT_SIDE_ENCRYPTION_ALGORITHM).toString();
    }
    ...
    public void setClientSideEncryptionKey(String key) {
        ...
        metadata.put(S3Headers.HOS_CLIENT_SIDE_ENCRYPTION_KEY, s);
        byte[] bytes = StringUtils.encrypByMD5Arr(key);
        metadata.put(S3Headers.HOS_CLIENT_SIDE_ENCRYPTION_KEY_MD5, Base64.getEncoder().encodeToString(bytes));
    }
    ...
    public String getClientSideEncryptionKey() {
        return metadata.get(S3Headers.HOS_CLIENT_SIDE_ENCRYPTION_KEY).toString();
    }
    ...
    public String getClientSideEncryptionKeyMD5() {
        return metadata.get(S3Headers.HOS_CLIENT_SIDE_ENCRYPTION_KEY_MD5).toString();
    }
    ...
    public void setObjectAcl(Permission permission) {
        metadata.put(S3Headers.HOS_OBJECT_ACL, permission != null ? permission.toString() : "");
    }
    ...
    public String getRequestId() {
        return (String) metadata.get(S3Headers.HOS_HEADER_REQUEST_ID);
    }
    ...
    public String getVersionId() {
        return (String) metadata.get(S3Headers.HOS_HEADER_VERSION_ID);
    }
    ...
    public Long getServerCRC() {
        String strSrvCrc = (String) metadata.get(S3Headers.HOS_HASH_CRC64_ECMA);
    ...
    public String getObjectRestoreStatus() {
        return (String) metadata.get(S3Headers.HOS_RESTORE);
    }
    ...
    public boolean isRestoreCompleted() {
        ...
        if (restoreString.equals(S3Headers.HOS_ONGOING_RESTORE)) {
            return false;
        }
        return true;
    }
