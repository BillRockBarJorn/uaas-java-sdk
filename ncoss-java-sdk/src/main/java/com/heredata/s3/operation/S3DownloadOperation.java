...
import static com.heredata.s3.utils.S3Utils.ensureObjectKeyValid;
...
/**
 * <p>Title: S3DownloadOperation</p>
 * <p>Description: 下载操作类 </p>
...
public class S3DownloadOperation {
    ...
    protected HOSObject getObjectWrap(GetObjectRequest getObjectRequest) {
    ...
    public InputStream getObjectInputstream(String bucket, String key) {
        ...
        HOSObject object = objectOperation.getObject(getObjectRequest);
    ...
    static class DownloadCheckPoint implements Serializable {
         ...
         */
        public synchronized boolean isValid(S3ObjectOperation objectOperation, DownloadFileRequest downloadFileRequest) {
    ...
    static class ObjectStat implements Serializable {
        ...
        public static ObjectStat getFileStat(S3ObjectOperation objectOperation, DownloadFileRequest downloadFileRequest) {
    ...
    public S3DownloadOperation(S3ObjectOperation objectOperation) {
    ...
    private DownloadFileResult downloadFileWithCheckpoint(DownloadFileRequest downloadFileRequest) throws Throwable {
        ...
        if (objectOperation.getInnerClient().getClientConfiguration().isCrcCheckEnabled() &&
            ...
            try {
                S3Utils.checkChecksum(clientCRC, serverCRC, downloadResult.getObjectMetadata().getRequestId());
            } catch (Exception e) {
    ...
    class Task implements Callable<PartResult> {
        ...
        public Task(int id, String name, DownloadCheckPoint downloadCheckPoint, int partIndex,
                    DownloadFileRequest downloadFileRequest, S3ObjectOperation objectOperation,
...
//                }
                getObjectRequest.setIncludeInputStream(true);
                HOSObject hosObj = getObjectWrap(getObjectRequest);
                objectMetadata = hosObj.getMetadata();
                content = hosObj.getObjectContent();
