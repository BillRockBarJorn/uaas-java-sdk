...
import com.heredata.s3.comm.S3Headers;
import com.heredata.s3.comm.S3RequestMessage;
import com.heredata.s3.handler.S3CallbackErrorResponseHandler;
import com.heredata.s3.handler.S3RequestMessageBuilder;
import com.heredata.s3.model.*;
import com.heredata.s3.parser.ResponseParsers;
import com.heredata.s3.utils.S3Utils;
...
import static com.heredata.s3.comm.S3RequestParameters.*;
import static com.heredata.s3.parser.RequestMarshallers.*;
import static com.heredata.s3.parser.ResponseParsers.*;
import static com.heredata.s3.utils.S3Utils.*;
 ...
 */
public class S3ObjectOperation extends S3Operation {

    public S3ObjectOperation(ServiceClient client, CredentialsProvider credsProvider) {
    ...
    public PutObjectResult putObject(PutObjectRequest putObjectRequest) throws ServiceException, ClientException {
        ...
        if (isCrcCheckEnabled()) {
            S3Utils.checkChecksum(result.getClientCRC(), result.getServerCRC(), result.getRequestId());
        }
    ...
    public PutObjectResult putObject(URL signedUrl, InputStream requestContent, long contentLength,
        ...
        S3RequestMessage request = new S3RequestMessage(null, null);
        ...
        if (requestHeaders.get(S3Headers.HOS_HEADER_CALLBACK) == null) {
    ...
    public HOSObject getObject(GetObjectRequest getObjectRequest) throws ServiceException, ClientException {
        ...
        if (!getObjectRequest.isIncludeInputStream()) {
            ...
            request = new S3RequestMessageBuilder(getInnerClient()).setEndpoint(getEndpoint(getObjectRequest))
            ...
            if (getObjectRequest.getClientSideEncryptionAlgorithm() != null) {
                ...
                headers.put(S3Headers.HOS_CLIENT_SIDE_ENCRYPTION_ALGORITHM, getObjectRequest.getClientSideEncryptionAlgorithm());
                headers.put(S3Headers.HOS_CLIENT_SIDE_ENCRYPTION_KEY, getObjectRequest.getClientSideEncryptionKey());
                headers.put(S3Headers.HOS_CLIENT_SIDE_ENCRYPTION_KEY_MD5, getObjectRequest.getClientSideEncryptionKeyMD5());
            }
...
//            HOSObject.setObjectContent(checkedInputstream);
    ...
    public ObjectMetadata getObject(GetObjectRequest getObjectRequest, File file) throws ServiceException, ClientException {
        ...
        try {
            ...
            if (isCrcCheckEnabled() && !hasRangeInRequest(getObjectRequest)) {
                ...
                S3Utils.checkChecksum(clientCRC, HOSObject.getServerCRC(), HOSObject.getRequestId());
            }
    ...
    public SimplifiedObjectMeta getSimplifiedObjectMeta(GenericRequest genericRequest) {
        ...
        S3RequestMessage request = new S3RequestMessageBuilder(getInnerClient()).setEndpoint(getEndpoint(genericRequest))
...
//        return doOperation(request, getSimplifiedObjectMetaResponseParser, bucketName, key);
    ...
    public CopyObjectResult copyObject(CopyObjectRequest copyObjectRequest) throws ServiceException, ClientException {
        ...
        S3RequestMessage request = new S3RequestMessageBuilder(getInnerClient()).setEndpoint(getEndpoint(copyObjectRequest))
    ...
    public VoidResult deleteVersion(DeleteVersionRequest deleteVersionRequest) throws ServiceException, ClientException {
        ...
        S3RequestMessage request = new S3RequestMessageBuilder(getInnerClient()).setEndpoint(getEndpoint(deleteVersionRequest))
    ...
    public DeleteVersionsResult deleteVersions(DeleteVersionsRequest deleteVersionsRequest)
        ...
        S3RequestMessage request = new S3RequestMessageBuilder(getInnerClient()).setEndpoint(getEndpoint(deleteVersionsRequest))
    ...
    public VoidResult setObjectAcl(SetAclRequest setAclRequest) throws ServiceException, ClientException {
        ...
        Map<String, String> headers = new HashMap<String, String>();
//        headers.put(S3Headers.HOS_OBJECT_ACL, cannedAcl.toString());
        ...
        S3RequestMessage request = new S3RequestMessageBuilder(getInnerClient()).setEndpoint(getEndpoint(setAclRequest))
    ...
    public VoidResult setObjectTagging(SetObjectTaggingRequest setObjectTaggingRequest) throws ServiceException, ClientException {
        ...
        S3RequestMessage request = new S3RequestMessageBuilder(getInnerClient()).setEndpoint(getEndpoint(setObjectTaggingRequest))
...
//            }
        ...
        S3RequestMessage httpRequest = new S3RequestMessageBuilder(getInnerClient()).setEndpoint(getEndpoint(originalRequest))
        ...
        reponseHandlers.add(new S3CallbackErrorResponseHandler());
    ...
    private boolean hasRangeInRequest(GetObjectRequest getObjectRequest) {
        return getObjectRequest.getHeaders().get(S3Headers.RANGE) != null;
    }
...
//            headers.put(S3Headers.COPY_OBJECT_SOURCE, copySourceHeader);
        ...
        headers.put(S3Headers.COPY_OBJECT_SOURCE, stringBuffer.toString().substring(0, stringBuffer.length() - 1));

        addHeader(headers, S3Headers.HOS_SERVER_SIDE_ENCRYPTION, copyObjectRequest.getServerSideEncryption());
        addHeader(headers, S3Headers.HOS_SERVER_SIDE_ENCRYPTION_KEY_ID, copyObjectRequest.getServerSideEncryptionKeyID());

        if (copyObjectRequest.getClientSideEncryptionAlgorithm() != null) {
            addHeader(headers, S3Headers.HOS_CLIENT_SIDE_ENCRYPTION_ALGORITHM, copyObjectRequest.getClientSideEncryptionAlgorithm().getAlgorithm());
            addHeader(headers, S3Headers.HOS_CLIENT_SIDE_ENCRYPTION_KEY, copyObjectRequest.getClientSideEncryptionKey());
            addHeader(headers, S3Headers.HOS_CLIENT_SIDE_ENCRYPTION_KEY_MD5, copyObjectRequest.getClientSideEncryptionKeyMD5());
            addHeader(headers, S3Headers.HOS_COPY_CLIENT_SIDE_ENCRYPTION__ALGORITHM, copyObjectRequest.getCopyClientSideEncryptionAlgorithm());
            addHeader(headers, S3Headers.HOS_COPY_CLIENT_SIDE_ENCRYPTION__KEY, copyObjectRequest.getCopyClientSideEncryptionKey());
            addHeader(headers, S3Headers.HOS_COPY_CLIENT_SIDE_ENCRYPTION__KEY_MD5, copyObjectRequest.getCopyClientSideEncryptionKeyMD5());
        }

        ObjectMetadata newObjectMetadata = copyObjectRequest.getNewObjectMetadata();
        if (newObjectMetadata != null) {
            headers.put(S3Headers.COPY_OBJECT_METADATA_DIRECTIVE, CopyObjectRequest.MetadataDirective.COPY.toString());
            if (newObjectMetadata.getRawMetadata().get(S3Headers.HOS_TAGGING) != null) {
                headers.put(S3Headers.COPY_OBJECT_TAGGING_DIRECTIVE, CopyObjectRequest.MetadataDirective.REPLACE.toString());
            }
    ...
    private static void populateGetObjectRequestHeaders(GetObjectRequest getObjectRequest,
        ...
        if (getObjectRequest.getModifiedSinceConstraint() != null) {
            headers.put(S3Headers.GET_OBJECT_IF_MODIFIED_SINCE,
        ...
        if (getObjectRequest.getUnmodifiedSinceConstraint() != null) {
            headers.put(S3Headers.GET_OBJECT_IF_UNMODIFIED_SINCE,
        ...
        if (getObjectRequest.getMatchingETagConstraints().size() > 0) {
            headers.put(S3Headers.GET_OBJECT_IF_MATCH, joinETags(getObjectRequest.getMatchingETagConstraints()));
        }

        if (getObjectRequest.getNonmatchingEtagConstraints().size() > 0) {
            headers.put(S3Headers.GET_OBJECT_IF_NONE_MATCH,
    ...
    private static void addGetObjectRangeHeader(long[] range, Map<String, String> headers) {
        ...
        headers.put(S3Headers.RANGE, rangeSpec.toString());
    }
}
