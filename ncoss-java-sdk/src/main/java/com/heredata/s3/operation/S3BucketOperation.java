...
import static com.heredata.s3.utils.S3Utils.ensureBucketNameCreationValid;
import static com.heredata.s3.utils.S3Utils.ensureBucketNameValid;
 ...
 */
public class S3BucketOperation extends S3Operation {

    public S3BucketOperation(ServiceClient client, CredentialsProvider credsProvider) {
...
//        headers.put(VERSIONS, null);
    ...
    public VoidResult setBucketLifecycle(SetBucketLifecycleRequest setBucketLifecycleRequest)
        ...
        S3RequestMessage request = new S3RequestMessageBuilder(getInnerClient()).setEndpoint(getEndpoint(setBucketLifecycleRequest))
    ...
    public VoidResult setBucketTagging(SetBucketTaggingRequest setBucketTaggingRequest) throws ServiceException, ClientException {
        ...
        S3RequestMessage request = new S3RequestMessageBuilder(getInnerClient()).setEndpoint(getEndpoint(setBucketTaggingRequest))
...
//        addRequestRequiredHeaders(headers, rawContent);
        ...
        S3RequestMessage request = new S3RequestMessageBuilder(getInnerClient()).setEndpoint(getEndpoint(setBucketVersioningRequest))
