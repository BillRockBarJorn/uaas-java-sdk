...
import static com.heredata.s3.parser.RequestMarshallers.completeMultipartUploadRequestMarshaller;
...
/**
 * <p>Title: S3MultipartOperation</p>
 ...
 */
public class S3MultipartOperation extends S3Operation {

    private static final int LIST_PART_MAX_RETURNS = 1000;
    private static final int LIST_UPLOAD_MAX_RETURNS = 1000;
    private static final int MAX_PART_NUMBER = 10000;

    public S3MultipartOperation(ServiceClient client, CredentialsProvider credsProvider) {
    ...
    public VoidResult abortMultipartUpload(AbortMultipartUploadRequest abortMultipartUploadRequest)
        ...
        S3RequestMessage request = new S3RequestMessageBuilder(getInnerClient()).setEndpoint(getEndpoint(abortMultipartUploadRequest))
...
//        populateRequestCallback(headers, completeMultipartUploadRequest.getCallback());
        ...
        S3RequestMessage request = new S3RequestMessageBuilder(getInnerClient()).setEndpoint(getEndpoint(completeMultipartUploadRequest))
...
//        }
    ...
    public InitiateMultipartUploadResult initiateMultipartUpload(
        ...
        if (initiateMultipartUploadRequest.getServerSideEncryption() != null) {
            headers.put(S3Headers.HOS_SERVER_SIDE_ENCRYPTION, initiateMultipartUploadRequest.getServerSideEncryption());
            headers.put(S3Headers.HOS_SERVER_SIDE_ENCRYPTION_KEY_ID, initiateMultipartUploadRequest.getServerSideEncryption());
        }
        ...
        if (initiateMultipartUploadRequest.getClientSideEncryptionAlgorithm() != null) {
            ...
            headers.put(S3Headers.HOS_CLIENT_SIDE_ENCRYPTION_ALGORITHM, initiateMultipartUploadRequest.getClientSideEncryptionAlgorithm().name());
            headers.put(S3Headers.HOS_CLIENT_SIDE_ENCRYPTION_KEY, initiateMultipartUploadRequest.getClientSideEncryptionKey());
            headers.put(S3Headers.HOS_CLIENT_SIDE_ENCRYPTION_KEY_MD5, initiateMultipartUploadRequest.getClientSideEncryptionKeyMD5());
        }

        // Be careful that we don't send the object's total size as the content
        // length for the InitiateMultipartUpload request.
        removeHeader(headers, S3Headers.CONTENT_LENGTH);
        ...
        // details.
        S3RequestMessage request = new S3RequestMessageBuilder(getInnerClient()).setEndpoint(getEndpoint(initiateMultipartUploadRequest))
    ...
    public MultipartUploadListing listMultipartUploads(ListMultipartUploadsRequest listMultipartUploadsRequest)
        ...
        S3RequestMessage request = new S3RequestMessageBuilder(getInnerClient()).setEndpoint(getEndpoint(listMultipartUploadsRequest))
    ...
    public PartListing listParts(ListPartsRequest listPartsRequest) throws ServiceException, ClientException {
        ...
        S3RequestMessage request = new S3RequestMessageBuilder(getInnerClient()).setEndpoint(getEndpoint(listPartsRequest))
    ...
    public UploadPartResult uploadPart(UploadPartRequest uploadPartRequest) throws ServiceException, ClientException {
        ...
        S3RequestMessage request = new S3RequestMessageBuilder(getInnerClient()).setEndpoint(getEndpoint(uploadPartRequest))
        ...
        result.setETag(trimQuotes(response.getHeaders().get(S3Headers.ETAG)));
...
//        }
    ...
    private static void populateUploadPartOptionalHeaders(UploadPartRequest uploadPartRequest,
        ...
        if (!uploadPartRequest.isUseChunkEncoding()) {
            ...
            headers.put(S3Headers.CONTENT_LENGTH, Long.toString(partSize));
        }

        if (uploadPartRequest.getMd5Digest() != null) {
            headers.put(S3Headers.CONTENT_MD5, uploadPartRequest.getMd5Digest());
        }
        ...
        if (objectMetadata != null && objectMetadata.getClientSideEncryptionAlgorithm() != null) {
            ...
            headers.put(S3Headers.HOS_CLIENT_SIDE_ENCRYPTION_ALGORITHM, objectMetadata.getClientSideEncryptionAlgorithm());
            headers.put(S3Headers.HOS_CLIENT_SIDE_ENCRYPTION_KEY, objectMetadata.getClientSideEncryptionKey());
            headers.put(S3Headers.HOS_CLIENT_SIDE_ENCRYPTION_KEY_MD5, objectMetadata.getClientSideEncryptionKeyMD5());
        }
