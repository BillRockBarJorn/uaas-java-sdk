...
import com.heredata.s3.signer.S3Signer;
import com.heredata.s3.signer.S3SignerParams;
...
import com.heredata.s3.handler.S3ErrorResponseHandler;
...
import static com.heredata.s3.utils.S3Utils.ensureEndpointValid;
...
public class S3Operation {
    ...
    protected static S3ErrorResponseHandler errorResponseHandler = new S3ErrorResponseHandler();
    ...
    protected S3Operation(ServiceClient innerClient, CredentialsProvider credsProvider) {
    ...
    public URI getEndpoint(WebServiceRequest request) {
        ...
        URI ret = S3Utils.toEndpointURI(reqEndpoint, defaultProto);
    ...
    private RequestSigner createSigner(String bucketName, String key, Credentials creds, ClientConfiguration config) {
        ...
        S3SignerParams params = new S3SignerParams(resourcePath, creds);
        params.setTickOffset(config.getTickOffset());
        return new S3Signer(params);
    }
