...
import com.heredata.s3.model.ObjectMetadata;
...
public class S3Utils {
    ...
    public static final ResourceManager HOS_RESOURCE_MANAGER = ResourceManager.getInstance(S3Constants.RESOURCE_NAME_HOS);
    ...
    public static boolean validateObjectKey(String key) {
        ...
        return (bytes.length > 0 && bytes.length < S3Constants.OBJECT_NAME_MAX_LENGTH);
    }
...
//        }
    ...
    public static void populateRequestCallback(Map<String, String> headers, Callback callback) {
        if (callback != null) {
            ...
            headers.put(S3Headers.HOS_HEADER_CALLBACK, base64Cb);
            ...
            if (callback.hasCallbackVar()) {
                ...
                headers.put(S3Headers.HOS_HEADER_CALLBACK_VAR, base64CbVar);
            }
        }
    }
        ...
        if (userMetadata != null) {
            for (Map.Entry<String, String> entry : userMetadata.entrySet()) {
                if (entry.getKey() != null && entry.getValue() != null) {
                    ...
                    headers.put(S3Headers.HOS_USER_METADATA_PREFIX + key, value);
                }
            }
        }
    }
