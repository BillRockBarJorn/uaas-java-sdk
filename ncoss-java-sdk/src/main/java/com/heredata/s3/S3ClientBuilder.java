...
import com.heredata.hos.HOSClient;
import com.heredata.s3.auth.DefaultCredentialProvider;
 ...
 *
 */
public class S3ClientBuilder implements S3Builder {

    @Override
    public S3 build(String endpoint, String account, String accessKey, String secretKey) {
        return build(endpoint, account, accessKey, secretKey, getClientConfiguration());
    }

    @Override
    public S3 build(String endpoint, String account, String accessKey, String secretKey, ClientConfiguration clientConfiguration) {
     ...
     */
    @Override
    public S3 build(String endpoint, String account, String accessKey, String secretKey, ClientConfiguration clientConfiguration, String bucket) {
        return new S3Client(endpoint, getDefaultCredentialProvider(accessKey, secretKey, account),
    ...
    @Override
    public S3 build(String endpoint, String accessKey, String secretKey) {
        return build(endpoint, accessKey, secretKey, getClientConfiguration(), null);
    }

    @Override
    public S3 build(String endpoint, String accessKey, String secretKey, ClientConfiguration clientConfiguration) {
        return build(endpoint, accessKey, secretKey, clientConfiguration, null);
    }

    @Override
    public S3 build(String endpoint, String accessKey, String secretKey, ClientConfiguration clientConfiguration, String bucket) {
        return new S3Client(endpoint, getDefaultCredentialProvider(accessKey, secretKey), clientConfiguration, bucket);
    }
}
