...
/**
 * <p>Title: HOSDownloadOperation</p>
 ...
 */
public class HOSDownloadOperation {
    ...
    static class DownloadCheckPoint extends ObjectInputStream implements Serializable {
         ...
         */
        public synchronized boolean isValid(HOSObjectOperation objectOperation, DownloadFileRequest downloadFileRequest) {
    ...
    static class ObjectStat implements Serializable {
        ...
        public static ObjectStat getFileStat(HOSObjectOperation objectOperation, DownloadFileRequest downloadFileRequest) {
    ...
    public HOSDownloadOperation(HOSObjectOperation objectOperation) {
    ...
    private DownloadFileResult downloadFileWithCheckpoint(DownloadFileRequest downloadFileRequest) throws Throwable {
        ...
        if (objectOperation.getInnerClient().getClientConfiguration().isCrcCheckEnabled() &&
            ...
            try {
                HOSUtils.checkChecksum(clientCRC, serverCRC, downloadResult.getObjectMetadata().getRequestId());
            } catch (Exception e) {
    ...
    class Task implements Callable<PartResult> {
        ...
        public Task(int id, String name, DownloadCheckPoint downloadCheckPoint, int partIndex,
                    DownloadFileRequest downloadFileRequest, HOSObjectOperation objectOperation,
