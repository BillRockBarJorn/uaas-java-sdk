...
/**
 * <p>Title: DefaultServiceClient</p>
 * <p>Description: 默认客户端连接器，当发送http请求时使用此默认类 </p>
 * <p>Copyright: Copyright (c) 2022</p>
 * <p>Company: Here-Data </p>
 * @author wuzz
 * @version 1.0.0
 * @createtime 2022/10/27 15:15
 */
public class DefaultServiceClient extends ServiceClient {
    ...
    protected static ResponseMessage buildResponse(Request request, CloseableHttpResponse httpResponse)
            throws IOException {
    ...
    private static class DefaultRetryStrategy extends RetryStrategy {
        ...
        public boolean shouldRetry(Exception ex, RequestMessage request, ResponseMessage response, int retries) {
            ...
            if (ex instanceof ServiceException) {
                ...
                if (errorCode.equals(HOSErrorCode.INVALID_RESPONSE)) {
                    return false;
                }
            }
