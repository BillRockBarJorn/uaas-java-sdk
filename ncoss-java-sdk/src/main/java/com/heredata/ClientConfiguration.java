...
import com.heredata.utils.AgentUtils;
 ...
 * <p>Description: 连接hos服务时的客户端配置类，可以设置一个默认信息 </p>
...
public class ClientConfiguration {
    ...
    public static final String DEFAULT_USER_AGENT = AgentUtils.getDefaultUserAgent();
    ...
    protected boolean crcCheckEnabled = false;
    ...
    public void setProxyPort(int proxyPort) throws ClientException {
        if (proxyPort <= 0) {
            throw new ClientException(
                    ResourceUtils.COMMON_RESOURCE_MANAGER.getString("ParameterIsInvalid"),
                    null);
        }
